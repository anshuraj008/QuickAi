  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center
     ...
     <div className='text-center mb-6'>
        ...
        font-semibold mx-auto leading-[1.2] dark:text-white transition-colors'>Use AI Tools to <br/> craft <span className='bg-gradient-to-r from-pink-600 to-purple-600 text-transparent bg-clip-text font-bold animate-pulse'> stunning content</span></h1>
     ...
     <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
      <button onClick={() => navigate('/ai')}  className='bg-gradient-to-r from-pink-600 to-purple-600 text-white px-10 py-3 rounded-lg hover:scale-105 hover:shadow-2xl hover:shadow-purple-300/50 active:scale-95 transition-all duration-300 cursor-pointer font-semibold'>Start Creating Now </button>
